...
DELIMITER //
CREATE PROCEDURE insert_RedSocial (IN redSocial varchar(255))
BEGIN
INSERT INTO TipoDeRedSocial (NombreRedSocial) VALUES(redSocial);
END//
DELIMITER ;

DELIMITER //
CREATE PROCEDURE update_RedSocial (IN redSocial varchar(255), IN redSocialID int(10))
BEGIN
UPDATE TipoDeRedSocial SET NombreRedSocial = redSocial WHERE ID = redSocialID;
END//
DELIMITER ;
...
-- EdicionEmpleados
DELIMITER //
CREATE PROCEDURE update_EdicionEmpleado (IN nombre varchar(255), email varchar(255), calle varchar(255), colonia varchar(255), cp int(10), ciudad varchar(255), 
											estado varchar(255), rfc varchar(255), fechaNac varchar(255), imgTrabajador1Loc varchar(255), sexo int(10), f1 int(10))
BEGIN
...
DELIMITER //
CREATE PROCEDURE insertTel_EdicionEmpleado (IN f1 int(10), tel varchar (20))
BEGIN
INSERT INTO Telefonos VALUES(f1, tel);
END//
DELIMITER ;

DELIMITER //
CREATE PROCEDURE insert_e_te (IN f1 int(10), tipo int(10))
BEGIN
INSERT INTO Empleado_TipoEmpleado VALUES((SELECT ID FROM Empleado WHERE ID = f1), tipo);
END//
DELIMITER ;
...
DELIMITER //
CREATE PROCEDURE insert_RedesSociales (IN f1 int(10), tabla varchar(255), id int (10))
BEGIN
INSERT INTO RedesSociales VALUES (f1, tabla, id);
END//
DELIMITER ;
